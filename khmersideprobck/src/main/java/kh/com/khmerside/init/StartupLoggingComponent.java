...
public class StartupLoggingComponent implements InitializingBean{
    ...
    private static final String PERSISTENCE_HOST_KEY = "jdbc.jdbcUrl";
    ...
    private void logPersistenceTarget(final Environment environment) {
        final String envTarget = getValueOfProperty(environment, PERSISTENCE_TARGET_KEY, "dev", Lists.newArrayList("dev", "local", "prod"));
